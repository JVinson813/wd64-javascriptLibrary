...
? FALSY VALUES:
    ...
    When JS is expecting a bollean value and it is returned with one of these 6 values it is evaluated as "falsy"
...
// ${} === this is called "interpolation" and way faster than adding a bunch of "+" sympols to string something together
