 ...
 * ******************
 ! CLASSES
 * ******************
    - Classes can be defined by either expression or delcaration
    - Classes are functions.
    - Classes act as a blueprint for creating objects.
        ex: model could be a porperty of a class of Automobile. Each new automobile we create that's a copy of our original class and could have a different value for the property model.
    ...
    - Introduced in ES5
    - New way to write previous existing prototype-basesd inheritance.
...
class Dog extends Animal {
    constructor(name, breed) {
        super(name); //'super' prior to 'this' keyword or will cause error
        this.type = breed;
        }
