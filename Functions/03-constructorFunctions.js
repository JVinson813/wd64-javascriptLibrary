...
* ***************
    ...
    -Functions allow us to easily create a unique solution for different circumstances by using parameters.
        -creating several different objects with the same keys and diff values.
...
/*
    ...
    5. This will be a key of the new object we will create. This NOT referring to the parameter.
