...
*************
    ...
    - allows us to upack values from arrays or properties from objects.
...
********************
    - Rest syntax looks exactly like spread syntax.
        ...
        - Rest collects multiple elements and concenses into a single element.
...
[charOne, charTwo, , , ...otherInfo] = hitchhikersGuide; // 2 extra commas meant skipping 2 elements in the original array
console.log('SKIPPED');
console.log(charOne);
console.log(charTwo);
console.log(otherInfo);
