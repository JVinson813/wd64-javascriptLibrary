...
const nameTwo = ['Zach', 'Maynard'];    // spreadOperator = "...variable"
...
nameOne.unshift('Mr');
console.log('Altered: ', nameOne, 'Spread: ', copiedNames); // "unshift" inserts new element at start of array
...
console.log(Math.min(...prices));   // Spread Op pulls elements out of the array to allow the min method to work
...
/*
    ...
    - 3 Data Types that are passed by reference: Array, Functions, and Objects
        - technically all are objects.
        - non primitive variables are given a reference to the value - the reference points to the location in the memory.
