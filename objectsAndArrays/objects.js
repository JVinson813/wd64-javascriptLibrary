...
//? DOT NOTATION
// While we use bracket notation with arrays, we us something called DOT NOTATION for objects.
...
/*
    ...
    -using object bracket notation can be handy if we wnat to store a key in a variable and then use that variable to parse through an object
...
//console.log(baking);
// We have the ability to set NEW key/vallue pairs using square brackets.
...
console.log(baking[garden['vegetable']])  // here we are saying the same thing as we did above, except we are passing info from our object.  garden['vegetable'] is the same as 'zucchini' up above.
